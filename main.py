    ...
    if inputFile.mode == "r":
        for LineNumber, line in enumerate(inputFile.readlines(), 1):
            ...
            if line[0] != " " and line[0] != ".": 
                if label in SYMTAB:          
                    print(f"Errors: Duplicate label: {label} Line: {LineNumber+1}")
                    return 0
                            ...
                            if operand[1] == 'C':
                                ...
                                if (len(operand)-4)%2==0:
                                    ...
                                    LITTAB[operand] = [ operand[3:-1], LenLiteral]
                                        ...
                                        print(f"Errors: Literal length must be Even: {operand} Line: {LineNumber+1}")
                                        return 0
            ...
            # End write to intermediate file
                ...
                if opcode in OPTAB:
                    ...
                    print(f"Errors: Invalid operation code:'{opcode}' Line:{LineNumber+1}")
                    return 0
